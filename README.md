...
![Gif](./assets/images/simple_landing_page.gif)
...
A Landing Page Simples foi desenvolvida com HTML5 e CSS3, cujo objetivo é demonstrar o meu aprendizado.

## 📝 Características:

Esta Landing Page apresenta um formato clean para demonstrar o seu trabalho, sendo adaptada para todas as telas.

## 🏁 Instalação:

Antes de começar, é bom ter um editor para trabalhar com o código, como: [VSCode](https://code.visualstudio.com/). Clone este repositório usando git clone: https://github.com/otaviopdev/Simple_Landing_Page.git ou clique em Code/Download ZIP. Clique no arquivo "index.html" e veja a aplicação.
